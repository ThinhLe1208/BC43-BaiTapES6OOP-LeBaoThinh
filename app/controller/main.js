...
const student2 = new Student('0002', 'Nguyen Van C', 'HN', 'nguyenvanb@gmail.com', '6', '5.5', '7');
const student3 = new Student('0007', 'Nguyen Van H', 'BT', 'nguyenvanh@gmail.com', '9', '9', '10');
const employee1 = new Employee('0003', 'Nguyen Van D', 'DN', 'nguyenvanc@gmail.com', '24', '230000');
const employee2 = new Employee('0004', 'Nguyen Van B', 'TN', 'nguyenvand@gmail.com', '22', '210000');
const employee3 = new Employee('0008', 'Nguyen Van K', 'LA', 'nguyenvank@gmail.com', '19', '310000');
const customer1 = new Customer('0005', 'Nguyen Van E', 'DL', 'nguyenvane@gmail.com', 'CDNCorp', '230000', 'Tot');
const customer2 = new Customer('0006', 'Nguyen Van G', 'GL', 'nguyenvang@gmail.com', 'MDNCorp', '460000', 'Kha');

// Tạo danh sách các đối tượng
const list = new ListPerson();
list.themDoiTuong(student1, student2, employee1, employee2, student3, customer1, employee3, customer2);
